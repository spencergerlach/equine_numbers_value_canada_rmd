...
```{r plot horses, fig.width=10, fig.height=3, fig.cap='Figure 1. Historical Horse Populations by Province', fig.align='center'}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap='Figure 2. One Province History', fig.align='center'}
